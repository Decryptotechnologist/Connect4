...
//    private Configuration config;
    ...
    */
    ...
    private void initComponents() {
        ...
        lgePanelSize = new Dimension(Connect4.getMainWidth() - 40, Connect4.getMainHeight() - 20);
        ...
        mainPanel = new JPanel(){
            ...
            protected void paintComponent(Graphics g) {
                ...
                g.drawImage(mainPanelImage, 0, -10, Connect4.getMainWidth() - 40, Connect4.getMainHeight() - 20, null);
            }
        };
...
//        jCheckBox16.setOpaque(false);
        ...
        Connect4.optionsWindow.add(mainPanel);
    ...
    */
    ...
    public void tick(Game game, boolean up, boolean down, boolean left, boolean right, boolean fire) {
        ...
        if(OMfirstTick) {
            ...
            Connect4.addOptions();
            Connect4.setStatusBar("Options Menu");
            Connect4.optionsWindow.validate();
...
//    }
    ...
    */
    ...
    private void graphicsPanel_L_TopMouseEntered(MouseEvent evt) {
        ...
        Connect4.setStatusBar("Graphics");
    ...
    private void gameplayPanel_L_CenterMouseEntered(MouseEvent evt) {
        ...
        Connect4.setStatusBar("Gameplay");
    ...
    private void restoreDefBtnMouseEntered(MouseEvent evt) {  
        ...
        Connect4.setStatusBar("Restore Defaults");
    }                                     
    ...
    private void restoreDefBtnMouseExited(MouseEvent evt) {
        ...
        Connect4.setStatusBar("Developer");
    }                                    
    ...
    private void backBtnMouseEntered(MouseEvent evt) {                                      
        ...
        Connect4.setStatusBar("Back to Main Menu");
    }                                     
    ...
    private void defineBtnMouseEntered(MouseEvent evt) {
        ...
        Connect4.setStatusBar("Define Keys");
    }                                     
    ...
    private void defineBtnMouseExited(MouseEvent evt) { 
        ...
        Connect4.setStatusBar("Controls");
    }                                    
    ...
    private void defineKeys() {
        ...
        game.setMenu(null);
        game.stateManager.setState("menu");
        Connect4.setStatusBar("Define Keys Menu");
    }
    ...
    private void defKeysBtnMouseEntered(MouseEvent evt) {
        ...
        Connect4.setStatusBar("Default Keys");
    }                                     
