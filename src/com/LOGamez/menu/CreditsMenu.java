...
//                target.scaleDraw(Texture.SI2015Logo, 1, Connect4.getMainWidth()-40-(CMTimer/2), 288, 0, 0, 281, 271, 0x000000);
//                target.scaleDraw(Texture.SI2015Logo, 1, Connect4.getMainWidth()-38-(CMTimer/2), 286, 0, 0, 281, 271, 0xffffff);
...
//            target.scaleDraw(Texture.SI2015Logo, 1, 168, 286, 0, 0, 281, 271, 0xff0400);
        ...
        if(CMTimer == 0){
            ...
            if(count % 18 == 0){
                int x = Connect4.getMainWidth()/2 - 168+count;
                double dx =  x * Math.sin(count/6);
                int y = Connect4.getMainHeight()/2 - 108-count;
...
//                animCredits.render(target, Connect4.getMainWidth()/2 - 168-count, Connect4.getMainHeight()/2 - 108-count, 1, 340, 180, creditsColor);
//                animCredits.render(target, Connect4.getMainWidth()/2 - 170-count, Connect4.getMainHeight()/2 - 110-count, 1, 340, 180, 0xffffff);

//                animCreditsA.render(target, Connect4.getMainWidth()/2 - 168-count, Connect4.getMainHeight()/2 - 108+count, 1, 340, 180, creditsColor);
//                animCreditsA.render(target, Connect4.getMainWidth()/2 - 170-count, Connect4.getMainHeight()/2 - 110+count, 1, 340, 180, 0xffffff);

//                animCreditsA.render(target, Connect4.getMainWidth()/2 - 168+count, Connect4.getMainHeight()/2 - 108+count, 1, 340, 180, creditsColor);
//                animCreditsA.render(target, Connect4.getMainWidth()/2 - 170+count, Connect4.getMainHeight()/2 - 110+count, 1, 340, 180, 0xffffff);
            }
            
//            animCreditsB.render(target, Connect4.getGameWidth()/2 - 168, Connect4.getGameHeight()/2 - 108, 1, 340, 180, creditsColor);
//            animCreditsB.render(target, Connect4.getGameWidth()/2 - 170, Connect4.getGameHeight()/2 - 110, 1, 340, 180, 0xffffff);
...
//                    animCreditsLightening.render(target, x, y, 0.35, 0.70, 260, 540, 0x00d5fc + random.nextInt(0xffffff + 1));
        ...
        if(CMSkipTimer < 20){
            ...
            if(MouseInput.MouseX > skipBtnX && MouseInput.MouseX < skipBtnX + skipBtnW && MouseInput.MouseY > skipBtnY && MouseInput.MouseY < skipBtnY + skipBtnH) {
                ...
                Connect4.setStatusBar("Credits Menu");
            }
        }
