...
public class MenuState implements State {
    ...
    private int menuImageW = Connect4.getMainWidth()+12;
    
    /**menuImageH variable of MenuState*/
    private int menuImageH = Connect4.getMainHeight()-15;
    ...
    private int aboutBtnX = Connect4.getMainWidth() - 90;
    
    /**aboutBtnY variable of MenuState*/
    private int aboutBtnY = Connect4.getMainHeight() - 100;
    ...
    private int versionX = Connect4.getMainWidth() - 50;
    
    /**versionY variable of MenuState*/
    private int versionY = Connect4.getMainHeight() - 40;
    ...
    */
    ...
    public void render(Graphics2D g){
		...
		Connect4.setStatusBar("Quit?");
                
                //Set Quit Button Click Logic
                if (MouseInput.MouseButton == 1) {
                    Sound.stopAll();
                    Sound.btnPushed.play();
                    Connect4.setStatusBar("Quit Game?");
