...
public class Game extends Canvas implements Runnable {
    ...
    public Game(int width, int height){
       ...
       //If screen null create new screen : gameWidth, gameHeight args
        ...
        img = new BufferedImage(Connect4.getMainWidth(), Connect4.getMainHeight(), BufferedImage.TYPE_INT_RGB);
...
//            win();
    ...
    */
    public void win() {
        ...
        Connect4.setStatusBar("Time Bonus: "+timeBonus+" Accuracy Bonus: "+accuracyBonus+" Level Bonus: "+levelBonus);
        ...
        if(levelNo+1 < 21){//Game Levels Limit : Currently set to 8
            ...
            levelNo += 1;
            //level = new Level(levelNo, SolarFox.getMainWidth(), SolarFox.getMainHeight());
            ...
            Connect4.setStatusBar("Game Complete!");
